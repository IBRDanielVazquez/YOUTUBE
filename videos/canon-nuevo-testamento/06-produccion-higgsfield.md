...
>
> **Actualización:** por pedido explícito del usuario se generaron ya los assets reales de las escenas 1, 2 y 3 (ver filas correspondientes abajo) — 2 imágenes fotorrealistas, 1 gráfico de tipografía y 2 videos (`seedance_2_0`, 7s y 8s a 720p). Costo real: **~71.75 créditos** (saldo restante: **38.25 de 110**). Las 40 escenas restantes siguen sin generar. Las URLs resultantes están alojadas en CloudFront de Higgsfield; este entorno no puede descargarlas directamente (bloqueo 403 de política de red al host `d8j0ntlcm91z4.cloudfront.net`) — el usuario las descarga manualmente desde las URLs listadas.
...
|---|---|---|---|---|
| 1 | `nano_banana_2` (still base) → `seedance_2_0` (start_image = still) | "Minimalist reconstruction of the Council of Nicaea, 325 AD, wide frontal shot, bishops seated in semicircle, cold blue window light, no ornate decoration, restrained historical documentary style, no dramatization" · video: dolly-in muy sutil, 7s, 720p | **GENERADO** — still: [job `3a7c46e6`](https://d8j0ntlcm91z4.cloudfront.net/user_3D2Eq6AUMHr9vhzDwT5CePiBHp4/hf_20260707_064913_3a7c46e6-23da-457a-9784-a92dabfa6d69.png) · video: [job `ff7e1995`](https://d8j0ntlcm91z4.cloudfront.net/user_3D2Eq6AUMHr9vhzDwT5CePiBHp4/hf_20260707_065028_ff7e1995-c6b6-49df-a179-cb61eac1245e.mp4) | Guardar como referencia de "set Nicea" para reusar en escenas 2 y 28 (continuidad visual vía `image_references`). URLs alojadas en CloudFront de Higgsfield — descarga manual pendiente (este entorno no puede alcanzar ese host por política de red) |
| 2 | `recraft_v4_1` (`model_type: utility`) | Tipografía "NICEA, 325 d.C." → "LO QUE NO DEBATIÓ: QUÉ LIBROS IBAN EN TU BIBLIA.", fondo negro, alto contraste | **GENERADO** (versión simplificada en inglés, "NICAEA, 325 AD") — [job `46ef280a`](https://d8j0ntlcm91z4.cloudfront.net/user_3D2Eq6AUMHr9vhzDwT5CePiBHp4/hf_20260707_065054_46ef280a-8808-495e-99d6-e25af9c85751.png) | Falta agregar la segunda línea de texto ("LO QUE NO DEBATIÓ...") y animar la aparición en edición (corte seco, sin motion nativo) |
| 3 | `nano_banana_2` (still) → `seedance_2_0` | "Dark wooden archive table, ancient manuscripts and facsimiles arranged as case-file evidence, warm single lamp light, rest in shadow, top-down composition" · video: travelling cenital lento, 8s | **GENERADO** — still: [job `41261a42`](https://d8j0ntlcm91z4.cloudfront.net/user_3D2Eq6AUMHr9vhzDwT5CePiBHp4/hf_20260707_065044_41261a42-9a50-408f-a954-4d3ca983430d.png) · video: [job `51fa4483`](https://d8j0ntlcm91z4.cloudfront.net/user_3D2Eq6AUMHr9vhzDwT5CePiBHp4/hf_20260707_065122_51fa4483-a680-4989-a07b-e2976503bea3.mp4) | Guardar como referencia de "set sala de archivo" para escenas 4, 5, 38, 40, 41. Descarga manual pendiente (mismo bloqueo de red) |
